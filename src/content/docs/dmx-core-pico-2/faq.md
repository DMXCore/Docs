...
Yes. J3 is the RP2040 Serial Wire Debug (SWD) port. It is a 3-pin **JST SH 1.0 mm** connector (`BM03B-SRSS-TB`), the Raspberry Pi 3-pin debug connector. Pinout: 1 = SWCLK, 2 = GND, 3 = SWDIO.

A [Raspberry Pi Debug Probe](https://www.raspberrypi.com/products/debug-probe/) plugs in directly with the included 3-pin JST cable. See the [Debug Probe documentation](https://www.raspberrypi.com/documentation/microcontrollers/debug-probe.html). Other debugger wiring is on the [Pin out](pin-out/#j3-debug-swd) page.
