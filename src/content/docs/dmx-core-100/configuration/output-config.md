...
On the configuration page you can edit the settings for the output, including deleting it.

![Output configuration detail](https://github.com/DMXCore/DmxCore100/assets/407941/31494897-eb63-4102-9b56-2aa5ecbf5c27)

The pixel type is only used for the built-in patterns and has no effect on cues and presets.
