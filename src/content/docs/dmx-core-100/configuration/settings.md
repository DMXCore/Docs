...
| Page | Description |
|------|-------------|
| **Lighting Setup > Inputs** | The input table (received universe → slot id, one protocol per row), the recording protocol, the [stream routing](/dmx-core-100/lighting/stream-routing) switch and the live sources |
