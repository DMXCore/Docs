...
![DMX Core 100 Box](/assets/IMG_3118.JPEG)

Open the box and carefully lift the DMX Core 100 at the top and bottom.

![DMX Core 100 in padded box](/assets/IMG_3120.JPEG)
...
![Back of the main unit. The DMX-512 board attaches to the connector labeled J5 and the two screw spacers.](/assets/IMG_3130.JPEG)

Here you'll see all the features of the rear of the main unit:
...
![DMX-512 board attached to DMX Core 100 main unit](/assets/IMG_3129.JPEG)

#### Power Up

Attach the network cable, and optionally the power supply connection if you're not using PoE, to the back of the main unit. Verify that it powers up (LED on back of unit; it takes about a minute before the screen comes up) and then mount it into the electrical box/frame. Be careful when mounting it into the electrical box as the display is close to the mounting holes and if the screwdriver slips it may damage the display, which would not be covered under warranty.
