...
- **LCD keys** — Every key shows its assignment's label, icon, and active/inactive background color. Keys with [Hold to confirm](/dmx-core-100/control-surfaces/configuring#hold-to-confirm) show a sweeping ring while held
...
Sliders support **Absolute** and **Relative** input modes, and Up/Down button assignments auto-repeat while held — useful for volume ramps from momentary buttons. [Hold to confirm](/dmx-core-100/control-surfaces/configuring#hold-to-confirm) works on value-carrying **Normal**-mode buttons; Toggle and address-only messages fire immediately because they have no press/release pair to hold.
