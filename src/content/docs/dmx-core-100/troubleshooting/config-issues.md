---
title: Config Issues
description: Common configuration issues and how to correct them
---

Especially when running on non-DMX Core 100 hardware, there are some configuration issues the system detects that can cause incorrect functionality and degraded performance. Here are a few and how to correct them.
