...
| v2026.909.x | 9/9/2026 | 2-port DMX-512 board, firmware 501: [End of Data](/dmx-core-100/playback/layers-and-priority#end-of-data) **Stop output** now stops the individual port, Output Off no longer drops a port that is being used as an input, and the board keeps up with sustained 40 fps host streams. The board's [Passthru Function](/dmx-core-100/lighting/passthrough) is now also under Lighting Setup > Protocol in the Web UI |
