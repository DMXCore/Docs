...
|---------|------|------------|
| v2026.916.x | 9/16/2026 | [Cues](/dmx-core-100/playback/cues#compressed-storage) can be stored **compressed** on disk: **Compress** on a cue's page shrinks a real recording 3–5x and plays it back in place, with in/out points, looping and bounce unchanged; **Decompress** restores the plain file. Downloads and backups then carry the `.cap.zst`, which Wireshark opens directly. Older releases cannot play compressed cues |
