...
| v2026.907.x | 9/7/2026 | Switching a device to an older software build now asks for confirmation with a back-up warning, and devices no longer offer leftover builds that were never meant for them |
